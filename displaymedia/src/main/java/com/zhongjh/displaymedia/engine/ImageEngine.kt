 ...
 */
package com.zhongjh.displaymedia.engine
...
/**
 * 图片不同加载方式
 * Image loader interface. There are predefined [com.zhongjh.displaymedia.engine.impl.GlideEngine]
 * and [com.zhongjh.displaymedia.engine.impl.PicassoEngine].
 * @author zhongjh
 */
