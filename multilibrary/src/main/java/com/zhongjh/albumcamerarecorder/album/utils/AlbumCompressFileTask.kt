...
class AlbumCompressFileTask(
     ...
     */
    fun isCompress(item: LocalMedia): LocalMedia? {
        // 判断是否需要压缩
...
//        }
     ...
     */
    fun getNewFileName(item: LocalMedia, path: String): String {
        // 移动文件,获取文件名称
     ...
     * @return 返回迁移后的file
     */
    fun getNewFile(item: LocalMedia, path: String, newFileName: String): File {
