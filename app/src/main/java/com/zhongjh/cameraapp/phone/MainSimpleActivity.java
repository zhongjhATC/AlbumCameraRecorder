        ...
        mBinding.mplImageList.setMaskProgressLayoutListener(new MaskProgressLayoutListener() {
            ...
            public void onItemClick(View view, MultiMediaView multiMediaView) {
                ...
                if (multiMediaView.getType() == MultimediaTypes.PICTURE) {
                    // 判断如果是图片类型就预览当前所有图片
                    MultiMediaSetting.openPreviewImage(MainSimpleActivity.this, REQUEST_CODE_CHOOSE,
                    ...
                    // 判断如果是视频类型就预览视频
                    MultiMediaSetting.openPreviewVideo(MainSimpleActivity.this, REQUEST_CODE_CHOOSE,
