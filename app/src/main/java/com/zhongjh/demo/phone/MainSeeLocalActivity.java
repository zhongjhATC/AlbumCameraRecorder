...
//                // 设置路径和7.0保护路径等等
//                .allStrategy(new SaveStrategy(true, "com.zhongjh.demo.fileProvider", "AA/test"))
//                // 如果设置这个，有关图片的优先权比allStrategy高
//                .pictureStrategy(new SaveStrategy(true, "com.zhongjh.demo.fileProvider", "AA/picture"))
//                // 如果设置这个，有关音频的优先权比allStrategy高
//                .audioStrategy(new SaveStrategy(true, "com.zhongjh.demo.fileProvider", "AA/audio"))
//                // 如果设置这个，有关视频的优先权比allStrategy高
//                .videoStrategy(new SaveStrategy(true, "com.zhongjh.demo.fileProvider", "AA/video"))
