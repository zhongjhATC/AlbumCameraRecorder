 ...
 * @date 2022/8/12
 */
public class CameraFragment1 extends BaseCameraFragment<CameraStateManager, CameraPictureViewManager, CameraVideoViewManager> {
    ...
    public void initView(View view, Bundle savedInstanceState) {
        ...
        mBinding.pvLayout.getPhotoVideoLayoutViewHolder().getBtnConfirm().setFunctionImage(com.zhongjh.multimedia.R.drawable.ic_baseline_keyboard_arrow_left_24,
                com.zhongjh.multimedia.R.drawable.avd_done_to_stop, com.zhongjh.multimedia.R.drawable.avd_stop_to_done);
        mBinding.pvLayout.getPhotoVideoLayoutViewHolder().getBtnCancel().setFunctionImage(com.zhongjh.multimedia.R.drawable.ic_baseline_done,
                com.zhongjh.multimedia.R.drawable.avd_done_to_stop, com.zhongjh.multimedia.R.drawable.avd_stop_to_done);

        // 修改副色调颜色
        mBinding.pvLayout.getPhotoVideoLayoutViewHolder().getBtnConfirm().setPrimaryVariantColor(com.zhongjh.multimedia.R.color.cpb_blue);

        // 定制样式 .确认按钮,修改主色调
        mBinding.pvLayout.getPhotoVideoLayoutViewHolder().getBtnConfirm().setPrimaryColor(com.zhongjh.multimedia.R.color.cpb_red);
        mBinding.pvLayout.getPhotoVideoLayoutViewHolder().getBtnCancel().setPrimaryColor(com.zhongjh.multimedia.R.color.cpb_red);
    }
