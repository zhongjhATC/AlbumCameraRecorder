 ...
 */
package com.zhongjh.grid.engine
...
/**
 * 图片不同加载方式
 * Image loader interface. There are predefined [com.zhongjh.grid.engine.impl.GlideEngine]
 * and [com.zhongjh.grid.engine.impl.PicassoEngine].
 * @author zhongjh
 */
